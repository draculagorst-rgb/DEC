...
<div align="center">
  <a href="https://github.com/mruniquehacker/DARK-XMD/fork">
...
<div align="center">
  <a href="https://youtu.be/-oz_u1i6Mgf8">
...
The DARK XMD WhatsApp Bot assists group admins by providing them with tools to efficiently manage large WhatsApp groups. The bot uses the Baileys library to interact with the WhatsApp Web API and supports multi-device features.
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/mruniquehacker/DARK-XMD.git
    cd DARK-XMD
    ```
...
This project is licensed under the [MIT License](https://opensource.org/licenses/MIT) - see the [LICENSE](https://github.com/mruniquehacker/DARK-XMD/blob/main/LICENSE) file for details.
